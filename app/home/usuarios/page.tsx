                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-[2rem] max-w-2xl w-full shadow-2xl border border-slate-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" value={newUser.nome} onChange={(e) => setNewUser({ ...newUser, nome: e.target.value })} className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800" placeholder="Ex: Ana Souza" />
                                    </div>
                                </div>
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="email" value={newUser.email} onChange={(e) => setNewUser({ ...newUser, email: e.target.value })} className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800" placeholder="ana.souza@empresa.com" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select value={newUser.filial} onChange={(e) => setNewUser({ ...newUser, filial: e.target.value })} className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 appearance-none">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select value={newUser.cargo} onChange={(e) => setNewUser({ ...newUser, cargo: e.target.value })} className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 appearance-none">
                                            <option value="">Selecione...</option>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" value={newUser.password || ''} onChange={(e) => setNewUser({ ...newUser, password: e.target.value })} className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 placeholder:text-slate-400" placeholder="Padrão: Mudar123!" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                    ...
                                    {permissoesDisponiveis.map(perm => (
                                        <label key={perm.id} className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer border transition-all ${newUser.permissoes.includes(perm.id)
                                            ...
                                            <div className={`w-5 h-5 rounded flex items-center justify-center border ${newUser.permissoes.includes(perm.id) ? 'bg-indigo-600 border-indigo-600' : 'bg-white border-slate-300'
                                                ...
                                                <input type="checkbox" checked={newUser.permissoes.includes(perm.id)} onChange={() => toggleNewUserPermission(perm.id)} className="hidden" />
                                            </div>
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                            <button onClick={() => setShowCreateModal(false)} className="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-white hover:shadow-sm transition-all text-sm">Cancelar</button>
                            <button onClick={handleCreateUser} className="px-6 py-3 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-200 transition-all text-sm">Criar Conta</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-[2rem] max-w-2xl w-full shadow-2xl border border-slate-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        <User className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                                        <input type="text" value={editUserData.nome} disabled={!isEditing} onChange={(e) => setEditUserData({ ...editUserData, nome: e.target.value })} className={`w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 ${!isEditing && 'opacity-60 cursor-not-allowed bg-slate-100'}`} />
                                    </div>
                                </div>
                                <div className="col-span-2">
                                    <label className="text-xs font-bold text-slate-500 uppercase mb-2 block">Email Corporativo</label>
                                    <div className="relative">
                                        ...
                                        <input type="email" value={editUserData.email} disabled className="w-full pl-10 pr-4 py-3 bg-slate-100 border border-slate-200 rounded-xl text-slate-500 cursor-not-allowed font-medium" />
                                    </div>
                                </div>
                                <div>
                                    <label className="text-xs font-bold text-slate-500 uppercase mb-2 block">Filial</label>
                                    <div className="relative">
                                        <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                                        <select value={editUserData.filial} disabled={!isEditing} onChange={(e) => setEditUserData({ ...editUserData, filial: e.target.value })} className={`w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 appearance-none ${!isEditing && 'opacity-60 cursor-not-allowed bg-slate-100'}`}>
                                            <option value="Matriz">Matriz</option>
                                            <option value="Filial 01">Filial 01</option>
                                            <option value="Filial 02">Filial 02</option>
                                            <option value="Filial 03">Filial 03</option>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Shield className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                                        <select value={editUserData.cargo} disabled={!isEditing} onChange={(e) => setEditUserData({ ...editUserData, cargo: e.target.value })} className={`w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 appearance-none ${!isEditing && 'opacity-60 cursor-not-allowed bg-slate-100'}`}>
                                            <option value="Administrador">Administrador</option>
                                            <option value="Supervisor">Supervisor</option>
                                            <option value="Atendente">Atendente</option>
                                            <option value="Técnico">Técnico</option>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        <Key className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                                        <input type="text" value={editUserData.password || ''} disabled={!isEditing} onChange={(e) => setEditUserData({ ...editUserData, password: e.target.value })} className={`w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium text-slate-800 ${!isEditing && 'opacity-60 cursor-not-allowed bg-slate-100'}`} placeholder={!isEditing ? "Bloqueado" : "Nova senha..."} />
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {permissoesDisponiveis.map(perm => (
                                        <label key={perm.id} className={`flex items-center gap-3 p-4 rounded-xl cursor-pointer border transition-all ${editUserData.permissoes.includes(perm.id)
                                            ? 'bg-indigo-50 border-indigo-200 shadow-sm'
                                            : isEditing ? 'bg-white border-slate-200 hover:border-indigo-200' : 'bg-slate-50 border-slate-100 cursor-not-allowed opacity-70'}`}>
                                            <div className={`w-5 h-5 rounded flex items-center justify-center border ${editUserData.permissoes.includes(perm.id) ? 'bg-indigo-600 border-indigo-600' : 'bg-white border-slate-300'}`}>
                                                ...
                                                <input type="checkbox" checked={editUserData.permissoes.includes(perm.id)} disabled={!isEditing} onChange={() => isEditing && toggleEditPermission(perm.id)} className="hidden" />
                                            </div>
                                            <span className={`text-sm font-bold ${editUserData.permissoes.includes(perm.id) ? 'text-indigo-900' : 'text-slate-600'}`}>{perm.label}</span>
                                        </label>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                            {!isEditing ? (
                                <>
                                    <button onClick={() => setShowEditModal(false)} className="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-white text-sm">Fechar</button>
                                    <button onClick={() => setIsEditing(true)} className="px-6 py-3 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 text-sm flex items-center gap-2"><Edit2 size={16} /> Liberar Edição</button>
                                </>
                            ) : (
                                <>
                                    <button onClick={() => setIsEditing(false)} className="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-white text-sm">Cancelar</button>
                                    <button onClick={handleEditUser} className="px-6 py-3 rounded-xl bg-emerald-600 text-white font-bold hover:bg-emerald-700 text-sm flex items-center gap-2"><Check size={16} /> Salvar Alterações</button>
                                </>
                            )}
                        </div>
                    </div>
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-[2rem] max-w-4xl w-full max-h-[85vh] shadow-2xl border border-slate-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col">
                        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 flex-shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center text-blue-600"><BarChart3 size={20} /></div>
                                <div>
                                    <h2 className="text-xl font-black text-slate-800">Relatório de Atividade</h2>
                                    <p className="text-xs text-slate-500 font-medium">Ações de {usuarios.find(u => u.id === selectedUserActivity)?.nome}</p>
                                </div>
                            </div>
                            <button onClick={() => setShowActivityReport(false)} className="p-2 hover:bg-slate-100 rounded-full text-slate-400 hover:text-slate-600 transition-colors"><X size={20} /></button>
                        </div>
                        <div className="p-0 overflow-y-auto flex-1 bg-slate-50/30">
                            {userActivities.length === 0 ? (
                                <div className="flex flex-col items-center justify-center h-64 text-slate-400"><Activity size={48} className="mb-4 opacity-20" /><p className="font-medium">Nenhuma atividade registrada.</p></div>
                            ) : (
                                    ...
                                    {userActivities.map(atividade => (
                                        <div key={atividade.id} className="p-6 hover:bg-white transition-colors flex gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between mb-1"><span className="font-bold text-slate-800 text-sm">{atividade.acao}</span><span className="text-xs text-slate-400 font-mono">{atividade.data}</span></div>
                                                <div className="text-xs font-semibold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md inline-block mb-2">{atividade.modulo}</div>
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end flex-shrink-0">
                            <button onClick={() => setShowActivityReport(false)} className="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-white text-sm">Fechar Relatório</button>
                        </div>
                    </div>
                </div>
            )}
